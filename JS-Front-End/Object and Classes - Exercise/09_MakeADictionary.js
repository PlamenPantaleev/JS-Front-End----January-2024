function makeADictionary(arrayInput) {
  let dictionary = {};

  for (const currentText of arrayInput) {
    const object = JSON.parse(currentText);
    const value = Object.entries(object);
    const currentKey = value[0][0];
...
//     console.log(`Term: ${current[0]} => Definition: ${current[1]}`);
//   }
}
